...
@Component({
  selector: 'app-bar-chart-occupation',
  templateUrl: './bar-chart-occupation.component.html',
  styleUrls: ['./bar-chart-occupation.component.css'],
})
export class BarChartOccupationComponent implements OnInit {
  @Input() title: string = '';
  ...
  private drawBars(data: any[]): void {
    ...
    const y = d3.scaleLinear().domain([0, 3]).range([this.height, 0]);
