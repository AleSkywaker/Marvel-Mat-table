...
@Component({
  selector: 'app-bar-chart-name',
  templateUrl: './bar-chart-name.component.html',
  styleUrls: ['./bar-chart-name.component.css'],
})
export class BarChartNameComponent implements OnInit {
  @Input() title: string = '';
